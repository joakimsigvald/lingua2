...
namespace Lingua.Core.Test
{
    ...
    public class EncoderTests
    {
        ...
        [TestCase("Tq", (5 << Encoder.ModifierBits) + (1 << 9))]
        [TestCase("Tdq", (5 << Encoder.ModifierBits) + 2 + (1 << 9))]
        ...
        [TestCase("R1", (7 << Encoder.ModifierBits) + (1 << 4))]
        [TestCase("R1n", (7 << Encoder.ModifierBits) + 1 + (1 << 4))]
        [TestCase("R2", (7 << Encoder.ModifierBits) + (1 << 5))]
        [TestCase("R2n", (7 << Encoder.ModifierBits) + 1 + (1 << 5))]
        [TestCase("R3", (7 << Encoder.ModifierBits) + (1 << 6))]
        [TestCase("R3n", (7 << Encoder.ModifierBits) + 1 + (1 << 6))]
        [TestCase("A", 8 << Encoder.ModifierBits)]
        [TestCase("X", 9 << Encoder.ModifierBits)]
        [TestCase("X1", (9 << Encoder.ModifierBits) + (1 << 4))]
        [TestCase("X2", (9 << Encoder.ModifierBits) + (1 << 5))]
        [TestCase("X3", (9 << Encoder.ModifierBits) + (1 << 6))]
        [TestCase("V", 10 << Encoder.ModifierBits)]
        [TestCase("V1", (10 << Encoder.ModifierBits) + (1 << 4))]
        [TestCase("V3", (10 << Encoder.ModifierBits) + (1 << 6))]
